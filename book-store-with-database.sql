...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2021 at 07:11 AM
...
--
CREATE DATABASE IF NOT EXISTS `db_book_store` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_book_store`;
...
('root', '[{\"db\":\"db_book_store\",\"table\":\"tbl_book\"},{\"db\":\"db_study\",\"table\":\"tbl_user_info\"},{\"db\":\"book_store\",\"table\":\"tbl_book\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__column_info\"},{\"db\":\"performance_schema\",\"table\":\"events_stages_current\"},{\"db\":\"mysql\",\"table\":\"column_stats\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__export_templates\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__favorite\"},{\"db\":\"performance_schema\",\"table\":\"cond_instances\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__designer_settings\"}]');
...
('root', '2021-06-17 05:10:34', '{\"Console\\/Mode\":\"show\",\"NavigationWidth\":223,\"Console\\/Height\":0}');
